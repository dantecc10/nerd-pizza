                ...
                <div class="collapse navbar-collapse" id="navcol-3">
                    ...
                    <div class="dropdown" style="padding-left: 0px;"><a class="dropdown-toggle" aria-expanded="false"
                        ...
                        <div class="dropdown-menu"
                            ...
                            <a class="dropdown-item" href="Login.html">Ingredientes</a>
                            <a class="dropdown-item" href="Registro.html">Inicio de sesión</a>
                        </div>
                    </div>
                </div>
            </div>
