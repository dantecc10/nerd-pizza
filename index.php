...
<head>
    ...
    <script src="https://equipo1.prog5a.com/assets/js/ModalInicioSesión.js"></script>
</head>
                ...
                switch ($categoría) {
                    ...
                    case 'complementos':
                        while ($columna = mysqli_fetch_array($resultado)) {
                            ...
                            $fotoComplemento = ("https://equipo1.prog5a.com/assets/img/complementos/" . $idComplemento . "/principal.jpg");
                            echo ("
                    ...
                    case 'bebidas':
                        while ($columna = mysqli_fetch_array($resultado)) {
                            ...
                            $fotoBebida = ("https://equipo1.prog5a.com/assets/img/complementos/" . $idBebidas . "/principal.jpg");
            ...
            <div class="col-lg-3 text-center text-lg-start d-flex flex-column align-items-center order-first align-items-lg-start order-lg-last item social">
                <div class="fw-bold d-flex align-items-center mb-2">
                    <span class="bs-icon-sm bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center bs-icon me-2" id="spanPizza">
                        <img src="https://equipo1.prog5a.com/assets/img/Nerd-Pizza.png" alt="Nerd Pizza" id="LogoNerdPizza"> </span><span>Nerd Pizza</span>
                </div>
