...
<head>
    ...
    <title>Maquetado Nerd Pizza</title>
    <link rel="stylesheet" href="assets/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="assets/css/Articles-Badges-images.css">
    <link rel="stylesheet" href="assets/css/Navbar-Centered-Links-icons.css">
    <!--     <link rel="stylesheet" href="../CSS/CSS GLOBAL - TEMA INSTITUCIONAL PUEBLA/CuerpoEstilo.css"> -->
</head>
    ...
    <section class="py-4 py-xl-5">
        <nav class="navbar navbar-light navbar-expand-md py-3">
            <div class="container"><a class="navbar-brand d-flex align-items-center" href="#"><span class="bs-icon-sm bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center me-2 bs-icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-bezier">
                ...
                <div class="collapse navbar-collapse" id="navcol-3">
                    ...
                    <div class="dropdown border rounded-pill d-md-flex flex-row justify-content-md-end"><a class="dropdown-toggle text-uppercase fw-semibold" aria-expanded="false" data-bs-toggle="dropdown" href="#">Menu&nbsp;</a>
                        <div class="dropdown-menu"><a class="dropdown-item" href="#">Registrase</a>
                            <a class="dropdown-item" href="#">Inicio de seción</a><a class="dropdown-item" href="#">Third
                                Item</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="text-center p-4 p-lg-5">
                <p class="fw-bold text-primary mb-2">Bienvenido a</p>
                <h1 class="fw-bold mb-4">Nerd Pizza</h1><button class="btn btn-primary fs-5 me-2 py-2 px-4" type="button">Pedir</button><button class="btn btn-light fs-5 py-2 px-4" type="button">Recoger</button>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-xl-4 offset-md-2">
                                <div style="max-width: 350px;">
                                    ...
                                    <p class="my-3">Tincidunt laoreet leo, adipiscing taciti tempor. Primis senectus
                                        sapien, risus donec ad fusce augue interdum.</p><a class="btn btn-primary btn-lg me-2" role="button" href="#">Button</a><a class="btn btn-outline-primary btn-lg" role="button" href="#">Button</a>
                                </div>
                            </div>
                        </div>
                    </div>
