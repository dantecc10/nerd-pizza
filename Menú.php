...
<head>
    <link rel="icon" type="image/jpeg" sizes="960x957" href="https://equipo1.prog5a.com/assets/img/Nerd-Pizza.png">
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, shrink-to-fit=no">
    <title>Ingredientes</title>
    <link rel="stylesheet" href="https://equipo1.prog5a.com/assets/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://equipo1.prog5a.com/assets/css/Articles-Badges-images.css">
    <link rel="stylesheet" href="https://equipo1.prog5a.com/assets/css/Navbar-Centered-Links-icons.css">
    <link rel="stylesheet" href="https://equipo1.prog5a.com/assets/fonts/fontawesome-all.min.css">
</head>
...
<body class="text-body" style="background-color: #969A97;">
    <section style="background-color: #F6CD13;">
        ...
        <nav class="navbar navbar-light navbar-expand-md py-3">
            <div class="container"><a class="navbar-brand d-flex align-items-center" href="index.php"><span class="bs-icon-sm bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center bs-icon me-2" id="spanPizza">
                        <img src="https://equipo1.prog5a.com/assets/img/Nerd-Pizza.png" alt="Nerd Pizza" id="LogoNerdPizza"> </span>
                ...
                <div class="collapse navbar-collapse" id="navcol-2">
                    <ul class="navbar-nav ms-auto">
                        ...
                        if ($_SESSION['idUsuario'] != "") {
                            ...
                            echo ("<li class='nav-item'><a class='nav-link' href='php scripts/CerrarSesión.php'>");
                        ?>
                            &nbsp; <?php echo ("Cerrar sesión</a></li>");
                                } else {
                    ...
                    <div class="dropdown show">
                        ...
                        <div class="dropdown-menu" data-bs-popper="none">
                            <a class="dropdown-item" href="Menú.php">Ingredientes</a>
    ...
    <section style="background-color: #F6CD13;">
        ...
        <div class='container'>
            ...
            function generarCatálogo($categoría, $conexión)
            {
                ...
                while ($columna = mysqli_fetch_array($resultado)) {
                    ...
                    $fotoPizza = ("https://equipo1.prog5a.com/assets/img/pizzas/" . $idPizza . "/principal.png");
            ...
            function generarCatálogoTotal($conexión)
            {
                ...
                while ($columna = mysqli_fetch_array($resultado)) {
                    ...
                    $fotoComplemento = ("https://equipo1.prog5a.com/assets/img/complementos/" . $idComplemento . "/principal.png");
        ...
        <!--<div class="card-deck">
            <div class="card">
                <img class="card-img-top" src="https://equipo1.prog5a.com/assets/img/pizzas/1/principal.png" alt="Card image cap">
                <div class="card-body">
    ...
    <div class="container text-center py-4 py-lg-5" style="background-color: #969A97;">
        <div class="row justify-content-center">
            <div class="col-lg-3 text-center text-lg-start d-flex flex-column align-items-center order-first align-items-lg-start order-lg-last item social">
                <div class="fw-bold d-flex align-items-center mb-2"><span class="bs-icon-sm bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center me-2 bs-icon" id="spanPizza">
                        <img src="https://equipo1.prog5a.com/assets/img/Nerd-Pizza.png" alt="Nerd Pizza" id="LogoNerdPizza">
                    </span>
                    <path fill-rule="evenodd" d="M0 10.5A1.5 1.5 0 0 1 1.5 9h1A1.5 1.5 0 0 1 4 10.5v1A1.5 1.5 0 0 1 2.5 13h-1A1.5 1.5 0 0 1 0 11.5v-1zm1.5-.5a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5h-1zm10.5.5A1.5 1.5 0 0 1 13.5 9h1a1.5 1.5 0 0 1 1.5 1.5v1a1.5 1.5 0 0 1-1.5 1.5h-1a1.5 1.5 0 0 1-1.5-1.5v-1zm1.5-.5a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5h-1zM6 4.5A1.5 1.5 0 0 1 7.5 3h1A1.5 1.5 0 0 1 10 4.5v1A1.5 1.5 0 0 1 8.5 7h-1A1.5 1.5 0 0 1 6 5.5v-1zM7.5 4a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5h-1z">
                    </path>
                    <path d="M6 4.5H1.866a1 1 0 1 0 0 1h2.668A6.517 6.517 0 0 0 1.814 9H2.5c.123 0 .244.015.358.043a5.517 5.517 0 0 1 3.185-3.185A1.503 1.503 0 0 1 6 5.5v-1zm3.957 1.358A1.5 1.5 0 0 0 10 5.5v-1h4.134a1 1 0 1 1 0 1h-2.668a6.517 6.517 0 0 1 2.72 3.5H13.5c-.123 0-.243.015-.358.043a5.517 5.517 0 0 0-3.185-3.185z">
        ...
        <div id="RedesSociales" align="center">
            ...
            <img class="RedSocial" alt="Ícono de Facebook" id="Facebook" onclick="javascript:AbrirFacebook();" src="https://equipo1.prog5a.com/assets/img/íconoFacebook.png" />
            <img class="RedSocial" alt="Ícono de WhatsApp" id="WhatsApp" onclick="javascript:AbrirWhatsApp();" src="https://equipo1.prog5a.com/assets/img/íconoWhatsApp.png" />
            <img class="RedSocial" alt="Ícono de Messenger" id="Messenger" onclick="javascript:AbrirMessenger();" src="https://equipo1.prog5a.com/assets/img/íconoMessenger.png" />
            <img class="RedSocial" alt="Ícono de Telegram" id="Telegram" onclick="javascript:AbrirTelegram();" src="https://equipo1.prog5a.com/assets/img/íconoTelegram.png" />
            <img class="RedSocial" alt="Ícono de Twitter" id="Twitter" onclick="javascript:AbrirTwitter();" src="https://equipo1.prog5a.com/assets/img/íconoTwitter.png" />
            <img class="RedSocial" alt="Ícono de Instagram" id="Instagram" onclick="javascript:AbrirInstagram();" src="https://equipo1.prog5a.com/assets/img/íconoInstagram.png" />
        </div>
    ...
    <script src="https://equipo1.prog5a.com/assets/bootstrap/js/bootstrap.min.js"></script>
</body>
