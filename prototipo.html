...
<body class="text-body" style="background-color: #969A97;">
    <section class="py-4 py-xl-5" style="background-color: #F6CD13;">
        ...
        <nav class="navbar navbar-light navbar-expand-md py-3">
            <div class="container"><a class="navbar-brand d-flex align-items-center" href="#"><span
                        ...
                        </svg></span><span>Nerd Pizza</span></a><button data-bs-toggle="collapse" class="navbar-toggler"
                ...
                <div class="collapse navbar-collapse" id="navcol-3">
                    ...
                    <div class="dropdown" style="padding-left: 0px;"><a class="dropdown-toggle" aria-expanded="false"
        ...
        <div class="container" style="height: 350px;">
            <div class="text-center p-4 p-lg-5">
                <p class="fw-bold text-primary mb-2" style="*color: #F62E28;"><span
                        style="color: rgb(246, 46, 40);">Bienvenido a</span></p>
                <h1 class="fw-bold mb-4">Nerd Pizza</h1>
                <button onclick="location.href='ingredientes.html'" class="btn btn-primary active fs-5 me-2 py-2 px-4" type="button"
                    style="background-color: #F62E28;">Menú</button>
        ...
        <div class="carousel slide" data-bs-ride="carousel" id="carousel-2" style="height: 600px;">
            <div class="carousel-inner h-100">
                ...
                <div class="carousel-item h-100"><img class="w-100 d-block position-absolute h-100 fit-cover"
                        src="IMG\pizzas\pizza mexicana banner.jpeg" alt="Slide Image" style="z-index: 1;">
                    <div class="container d-flex flex-column justify-content-center h-100">
                        <div class="row">
                ...
                <div class="carousel-item h-100"><img class="w-100 d-block position-absolute h-100 fit-cover"
                        src="IMG\pizzas\Cheese Pizza.jpg" alt="Slide Image" style="z-index: 1;">
                    <div class="container d-flex flex-column justify-content-center h-100">
                        <div class="row">
    ...
    <div class="container text-center py-4 py-lg-5" style="background-color: #969A97;">
        ...
        <div id="RedesSociales" align="center">
            <hr id="AntesSociales">
            <script lang="JavaScript" src="JS/Redes_Sociales.js"></script>
            ...
            <img class="RedSocial" alt="Ícono de Instagram" id="Instagram" onclick="javascript:AbrirInstagram();"
                src="IMG\íconoInstagram.png" />
        </div>
        <div
            class="text-center text-sm-center text-md-center text-lg-center text-xl-center text-xxl-center d-flex justify-content-center align-items-center align-content-center justify-content-md-center align-items-md-center pt-3">
            <p
                class="text-center text-muted d-flex d-md-flex align-items-center justify-content-md-center align-items-md-center mb-0">
